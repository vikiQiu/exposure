...
class DataProvider(object):
    ...
    def get_next_batch_(self, batch_size):
        ...
        batch_images = np.empty(
            (batch_size,) + self.output_size + self.data.shape[3:],  # (batch_size, h, w, c)
        ...
        ## Hao
        return batch_images * self.image_scaling, np.zeros((batch_size,))  # batch, features
        # print(batch.shape)
