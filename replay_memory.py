...
class ReplayMemory:
    ...
    def __init__(self, cfg, load):
        ...
        self.image_pool = []  # A list of Dict of [image, state, feature]
        self.target_pool_size = cfg.replay_memory_size  # 128
    ...
    def get_next_RAW(self, batch_size, test=False):
        ...
        return self.records_to_images_and_states(pool)  # images[batch_size, h, w, c] and states[batch_size, 11]
    ...
    def get_next_fake_batch(self, batch_size):
        '''get a batch of [images, states, features]'''
        # print('get_next')
        random.shuffle(self.image_pool)
...
if __name__ == '__main__':
    ...
    print(cfg)
    memory = ReplayMemory(cfg, load=True)
    a = memory.get_next_fake_batch(4)
    print(a)